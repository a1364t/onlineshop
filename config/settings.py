...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = env("EMAIL_SERVER")
EMAIL_HOST_PASSWORD = env("EMAIL_SERVER_PASSWORD")
...
ACCOUNT_PASSWORD_RESET_EMAIL_TEMPLATE = 'account/email/password_reset_key_message.txt'
