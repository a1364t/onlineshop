(function ($) {
  ...
  var $html = $("html"),
    ...
    $pageUrl = window.location.href.substr(
      window.location.href.lastIndexOf("/") + 1
    ),
    $header = $(".header"),
    $overlay = $(".ShoppingYar-global-overlay"),
    $headerPosition = $header.elExists() ? $header.offset().top : "",
    $mainHeaderHeight = $header.elExists()
  ...
  $("[data-countdown]").each(function () {
    ...
    $this.countdown(finalDate, function (event) {
      $this.html(
        event.strftime(
          '<div class="single-countdown"><span class="single-countdown__time">%D</span><span class="single-countdown__text">Day</span></div><div class="single-countdown"><span class="single-countdown__time">%H</span><span class="single-countdown__text">Hour</span></div><div class="single-countdown"><span class="single-countdown__time">%M</span><span class="single-countdown__text">Min</span></div><div class="single-countdown"><span class="single-countdown__time">%S</span><span class="single-countdown__text">Sec</span></div>'
        )
      );
    });
  });
  ...
  $('input[name="payment-method"]').on("click", function () {
    ...
    $(this)
      .parents(".payment-group")
      .siblings(".payment-group")
  ...
  if ($elementCarousel.elExists()) {
    ...
    /*For ltr*/
    if ($html.attr("dir") == "ltr" || $body.attr("dir") == "ltr") {
      $elementCarousel.attr("dir", "ltr");
    }
    ...
    $elementCarousel.each(function (index, element) {
      ...
      var $spaceBetween = $options.spaceBetween
        ...
        $ltr =
          $options.ltr || $html.attr('dir="ltr"') || $body.attr('dir="ltr"')
            ? true
            : false,
  ...
  videoPopup.magnificPopup({
    type: "iframe",
    closeMarkup:
      '<button type="button" class="custom-close mfp-close"><i class="flaticon flaticon-cross mfp-close"></i></button type="button">',
  });
  ...
  $(document).on(
    "click.nice_select",
    ".product-categories .nice-select .option:not(.disabled)",
    function (e) {
      var $this = $(this),
  ...
  $(".variation-btn").on("click", function (e) {
    ...
    var $child = $parent
      ...
      .children(".product-price-wrapper")
      .children("span");
